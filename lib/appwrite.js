...
export async function createSendPost(form) {
  ...
  try {
    ...
    } else if (form.grade.startsWith("V") && form.userMaxBoulderingGrade < form.grade) {
      const updateUserMaxGrade = await databases.updateDocument(
        appwriteConfig.databaseId,
        appwriteConfig.userCollectionId,
        form.userId,
...
export async function createProjectPost(form) {
  ...
  try {
    ...
    // create a send related to the project
    ...
    // console.log("========================")
    // console.log(relatedSend);
    // console.log(newProjectPost.$id);

...
export async function editSendPost(form) {
  // console.log("editSendPost", form);
  let strGrade = form.grade.substring(1);
  let strMaxGrade = form.userMaxBoulderingGrade.substring(1);
  // Number(form.attempts);
  // console.log('form grade',form.grade);
  // console.log('strGrade',strGrade);
  // console.log('strMaxGrade',strMaxGrade);
  // console.log("editSendPost", Number(strMaxGrade) < Number(strGrade));
  // console.log("editSendPost", form.grade.startsWith("V"));
...
export async function createProjectPost(form) {
  ...
  try {
    ...
    if (form.climbsent === true) {
      ...
      console.log('project created', newProjectPost)

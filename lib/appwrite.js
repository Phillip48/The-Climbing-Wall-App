...
// Register user
export async function createUser(email, password, username, maxBoulderingGrade, maxTopRopingGrade, bio) {
  try {
...
export async function searchSends(query) {
  try {
    const posts = await databases.listDocuments(
      appwriteConfig.databaseId,
      appwriteConfig.sendsCollectionId,
